            ...
            <div className="hero-body">
              <div className="images is-hidden-touch">
                <div className="nube nube1 animated fadeInLeft slower ">
                  <img alt="[CLOUD]" src={require('../../assets/images/nubesita.png')}/>
                </div>
                ...
                <div className="animated pulse">
                  <img alt="[UZIDAY LOGO]" className="brandLogo" src={require('../../assets/images/UziLogo.png')}/>
                  <br/>&nbsp;<br/>
                  ...
                  <a href="https://mailchi.mp/d3bc4cb8c456/uziday-notifications" target="_blank" className="button i-want-subscribe is-medium">
